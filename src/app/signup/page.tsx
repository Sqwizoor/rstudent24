    ...
    <div className="dark min-h-screen bg-[#000000] text-zinc-100 flex items-center justify-center p-4 selection:bg-zinc-800">
      ...
      <Card className="relative w-full max-w-md rounded-2xl border border-zinc-800/80 bg-zinc-950/85 backdrop-blur-xl shadow-2xl shadow-black/80 my-8">
        ...
        <CardContent className="space-y-4 px-6">
          ...
          {/* Step 2: Google Sign Up Button (Prominently visible at the top) */}
          <div className="pt-1">
            <Button
              type="button"
          ...
          {/* Step 3: Full Email & Password Form */}
          <form onSubmit={handleEmailSignUp} className="space-y-3">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-11 bg-zinc-800 hover:bg-zinc-700 text-white font-semibold rounded-xl text-xs flex items-center justify-center gap-2 transition-all shadow-md active:scale-[0.98] mt-2 border border-zinc-700"
            >
              {isLoading ? (

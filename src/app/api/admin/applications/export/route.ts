...
export async function GET(request: NextRequest) {
  try {
    ...
    // Get all applications with related data from Convex Cloud directly
    ...
    try {
      ...
      const res = await fetch(`${CONVEX_URL}/api/query`, {
        ...
        body: JSON.stringify({ path: "applications:getAdminApplications", args: { limit: 5000 } }),
      });
      ...
      console.warn("Convex export fetch warning:", convexErr);
    }

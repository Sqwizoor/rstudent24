    ...
    <div className="dark min-h-screen bg-[#000000] text-zinc-100 flex items-center justify-center p-4 selection:bg-zinc-800">
      ...
      <Card className="relative w-full max-w-md rounded-2xl border border-zinc-800/80 bg-zinc-950/85 backdrop-blur-xl shadow-2xl shadow-black/80 my-8">
        ...
        <CardContent className="space-y-4 px-6">
          ...
          {/* Step 2: Google Sign In Button (Prominently visible at the top) */}
          <div className="pt-1">
            <Button
              type="button"
            ...
            >
              {isLoading ? (
                ...
                <>
                  ...
                  <span>Continue with Google as {role === "student" ? "Student" : "Landlord"}</span>
                </>
              )}
            </Button>
          </div>
          ...
          <form onSubmit={handleEmailSignIn} className="space-y-3">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-10 bg-zinc-800 hover:bg-zinc-700 text-white font-semibold rounded-xl text-xs flex items-center justify-center gap-2 transition-all mt-2 active:scale-[0.98] border border-zinc-700"
            >
              {isLoading ? (
        ...
        <CardFooter className="flex flex-col space-y-3 text-center pb-6 border-t border-zinc-800/80 pt-4">

    ...
    try {
      ...
      if (propertySearchResponse.ok) {
        ...
        if (properties && properties.length > 0) {
          console.log(
            `Found ${properties.length} property matches for "${trimmedQuery}"`
          );
      ...
      console.log(
        `No property matches found for "${trimmedQuery}", trying geocoding...`
      );
            ...
            <div className="max-w-5xl mx-auto md:bg-white dark:bg-gray-800 rounded-md md:rounded-full shadow-lg overflow-hidden mb-4 w-full p-2">
              <div className="flex flex-col md:flex-row items-center gap-2">
                ...
                <div className="w-full md:w-auto md:pt-0 pt-6 px-2">
                  <Button
                    className="w-full bg-[#00acee] hover:bg-[#0099d4] text-white rounded-full md:rounded-full px-[4rem] py-8 text-sm"

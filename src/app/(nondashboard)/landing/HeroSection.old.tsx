        ...
        >
          ...
          <div className="text-center mb-6 md:mb-8">
            <motion.h1
              ...
              className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold text-white mb-4 tracking-tight"
            >
              Find any res.
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-base md:text-xl text-white/80 max-w-xs md:max-w-2xl mx-auto font-normal"
            >
              Find accommodations close to campus at your budget.
            </motion.p>
          </div>
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                <Select defaultValue="any">
                  <SelectTrigger className="w-full h-12 bg-white border-0 rounded-lg">
                    <SelectValue placeholder="Rent" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="any">any</SelectItem>
            ...
            {/* University Location Buttons - Only show on desktop */}
